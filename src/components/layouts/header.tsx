            ...
            <header className={'h-full pt-3'}>
                <nav className={'flex justify-between items-center bg-transparent p-[0.5rem] w-full'}>
                    ...
                    <div className={'w-2/3 h-[46px] rounded-3xl relative shadow-2xl shadow-[#0af3f3]'}>
                        ...
                        <input
                            className=" w-full h-[46px] bg-gray-500 rounded-3xl placeholder:italic
                            placeholder:text-amber-50 py-2 pl-9 pr-3 focus:border-sky-500
                            focus:ring-sky-500 focus:ring-1 sm:text-lg"
                ...
                <div className={' w-full h-[46px]  mt-3 flex justify-between items-center'}>
                    ...
                    <div className={'header_nav_bar header_nav_bar_color w-full  ml-1'}>

                        <Link to={'/laptop'}>
                            <button className={'aaaa w-full h-[46px]  focus:outline-none'}>
                                <b>  LAPTOPS</b>
                            </button>
                        </Link>
