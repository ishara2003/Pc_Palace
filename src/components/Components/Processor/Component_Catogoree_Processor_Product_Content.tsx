...
function Component_Catogoree_Processor_Product_Content() {
                ...
                <div
                    className={'grid 2xl:grid-cols-3 xl:grid-cols-2 lg:grid-cols-1 md:grid-cols-1 sm:grid-cols-1 w-fit relative m-auto'}>
                    {
                        data.map((r: Data, index: number) => {
                            ...
                            return <Product title={r.title} productImage={"src/assets/products/Processors.png"} discount_price={r.id}
                                                            fixed_price={r.id}/>
                        })
                    }
