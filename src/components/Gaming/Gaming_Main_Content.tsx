...
function Gaming_Main_Content() {
  ...
  return (
    <div className = {"main_content_root p-4 "}>
      <h1
        className={
          "w-fit laptop_header text-4xl relative left-[300px] top-[-5px] mb-2"
        }
      >
        <b>{gamingCurrentCategory}</b>
      </h1>
      ...
      <ul  className = {"text-[20px] pt-6 pb-8 text-left "}>
              <b>
                <li
                  className={
                    "header_nav_bar header_nav_bar_color w-full h-[60px] p-[10px] mt-[30px] mb-[30px] border-[4px] border-cyan-500"
                  }
                  onClick={() => {
        ...
        <div className = {"w-full h-full border-l-[#0af3f3] border-l-4 p-2 "}>
          ...
          {gamingCurrentCategory == "DESKTOPS" && (
            <>
              <Gaming_Desktop_Product_Content score = {score} />
          ...
          {gamingCurrentCategory == "MONITORS" && (
            <>
              <Gaming_Monitor_Product_Content score = {score} />
          ...
          {gamingCurrentCategory == "ACCESSORIES" && (
            <>
              <Gaming_accessories_Product_Content score = {score} />
          ...
          {gamingCurrentCategory == "LAPTOPS" && (
            <>
              <Gaming_Laptop_Product_Content score = {score} />
          ...
          {gamingCurrentCategory == "" && (
            <>
              < Gaming_Product_Content score = {score} />
